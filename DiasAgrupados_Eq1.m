...
dlmwrite ('EspectrosMMO_exclusao1_ASS_agrupados_Eq1.dat', Espectros_1, 'delimiter','\t', 'precision',4)
dlmwrite ('EspectrosMMO_exclusao1_SADIA_agrupados_Eq1.dat', Espectros_2, 'delimiter','\t', 'precision',4)
dlmwrite ('EspectrosMMO_exclusao1_SINT_agrupados_Eq1.dat', Espectros_3, 'delimiter','\t', 'precision',4)
